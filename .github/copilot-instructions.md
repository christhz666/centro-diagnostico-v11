...
- **Offline app bootstrap exception:** `GET /api/admin/usuarios/offline-sync` is intentionally public and must stay before `router.use(protect)` in `routes/admin.js`.
