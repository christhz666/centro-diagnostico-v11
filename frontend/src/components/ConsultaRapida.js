              ...
              <div style={{ background: theme.surface, padding: 24, borderRadius: 16, boxShadow: '0 4px 20px rgba(0,0,0,0.08)', borderTop: `5px solid ${colores.azulOscuro}`, height: 'fit-content' }}>
                ...
                {facturaSeleccionada && facturaSeleccionada.codigoLIS && (
                  <div style={{ marginTop: 15, background: theme.surfaceMuted, padding: 14, borderRadius: 10, textAlign: 'center', border: `2px dashed ${theme.infoBorder}` }}>
                    <div style={{ fontSize: 12, color: theme.text, fontWeight: 600, textTransform: 'uppercase', letterSpacing: 1 }}>ID LIS (MÁQUINAS)</div>
                    <div style={{ fontSize: 24, fontWeight: 'bold', color: theme.accentStrong, fontFamily: 'monospace', letterSpacing: 2 }}>{facturaSeleccionada.codigoLIS}</div>
                  </div>
                )}
              </div>
