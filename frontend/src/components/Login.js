...
const Login = ({ onLogin, empresaConfig = {}, authNotice = '' }) => {
    const empresaNombre = empresaConfig.nombre || empresaConfig.empresa_nombre || 'MedTech OS';
        ...
        >
            ...
            <main className="w-full max-w-[440px] relative z-10">
                ...
                <div className="flex flex-col items-center mb-10">
                    <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#4afdef] to-[#00e0d3] flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(0,224,211,0.3)] p-2">
                        {empresaConfig.logo_login ? (
                            <img src={empresaConfig.logo_login} alt="Logo" className="max-h-12 object-contain" />
                        ) : (
