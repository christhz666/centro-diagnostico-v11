        ...
        {paso === 1 && (
          <section className="bg-white dark:bg-[#1d2027]/70 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-gray-200 dark:border-white/5 animate-in slide-in-from-right-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8">
              <div className="flex items-center gap-2 bg-[#0b0e15] p-1.5 rounded-xl border border-gray-200 dark:border-white/5">
                <button onClick={() => { setModoPaciente('nuevo'); setBusqueda(''); setPacientes([]); }} className={`px-6 py-2.5 rounded-lg font-bold text-sm transition-all focus:outline-none ${modoPaciente === 'nuevo' ? 'bg-[#4afdef] text-[#00201d] shadow-[0_0_15px_rgba(74,253,239,0.3)]' : 'text-gray-600 dark:text-[#bacac7] hover:text-gray-900 dark:text-white bg-transparent'}`}>Nuevo Paciente</button>
                <button onClick={() => setModoPaciente('existente')} className={`px-6 py-2.5 rounded-lg font-bold text-sm transition-all focus:outline-none ${modoPaciente === 'existente' ? 'bg-[#4afdef] text-[#00201d] shadow-[0_0_15px_rgba(74,253,239,0.3)]' : 'text-gray-600 dark:text-[#bacac7] hover:text-gray-900 dark:text-white bg-transparent'}`}>Paciente Existente</button>
              </div>
                        ...
                        {pacientes.map(p => (
                            <div key={p._id || p.id} onClick={() => seleccionarPacienteExistente(p)} className="bg-gray-50 dark:bg-[#272a31] border border-gray-200 dark:border-white/5 hover:border-[#4afdef]/50 hover:bg-gray-100 dark:bg-[#32353c] p-5 rounded-xl cursor-pointer transition-all group hover:shadow-[0_0_15px_rgba(74,253,239,0.1)]">
                                <div className="flex justify-between items-start mb-2">
                                    <strong className="text-gray-900 dark:text-white font-headline text-lg group-hover:text-[#4afdef] transition-colors line-clamp-1">{p.nombre} {p.apellido}</strong>
                ...
                <div className="space-y-8 animate-in slide-in-from-bottom-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6">
                        <div className="relative group">
                            <label className="block text-[10px] uppercase tracking-widest text-gray-500 dark:text-[#849491] mb-1 ml-1 font-bold">Nombre *</label>
                        ...
                        <div className="relative group">
                            <label className="block text-[10px] uppercase tracking-widest text-gray-500 dark:text-[#849491] mb-1 ml-1 font-bold">Apellido *</label>
                        ...
                        <div className="relative group">
                            <label className="block text-[10px] uppercase tracking-widest text-gray-500 dark:text-[#849491] mb-1 ml-1 font-bold">Cédula / ID</label>
                        ...
                        <div className="relative group">
                            <label className="block text-[10px] uppercase tracking-widest text-gray-500 dark:text-[#849491] mb-1 ml-1 font-bold">F. Nacimiento *</label>
                        ...
                        <div className="relative group">
                            <label className="block text-[10px] uppercase tracking-widest text-gray-500 dark:text-[#849491] mb-1 ml-1 font-bold">Sexo *</label>
                        ...
                        <div className="relative group">
                            <label className="block text-[10px] uppercase tracking-widest text-gray-500 dark:text-[#849491] mb-1 ml-1 font-bold">Teléfono *</label>
                        ...
                        <div className="relative group lg:col-span-3">
                            <label className="block text-[10px] uppercase tracking-widest text-gray-500 dark:text-[#849491] mb-1 ml-1 font-bold">Email</label>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start animate-in slide-in-from-right-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[600px] overflow-y-auto custom-scrollbar pr-2 pb-4">
                        {estudios.filter(e => (e.nombre || '').toLowerCase().includes(filtroCategoria.toLowerCase()) || (e.codigo || '').toLowerCase().includes(filtroCategoria.toLowerCase())).map(e => (
                            <div key={e._id || e.id} onClick={() => agregarEstudio(e)} className="bg-gray-50 dark:bg-[#272a31] p-5 rounded-xl border border-gray-200 dark:border-white/5 hover:bg-gray-100 dark:bg-[#32353c] hover:border-[#4afdef]/30 transition-all group cursor-pointer hover:shadow-[0_0_15px_rgba(74,253,239,0.1)] flex flex-col justify-between min-h-[140px]">
                                <div>
                ...
                <aside className="sticky top-24 bg-white dark:bg-[#1d2027]/80 backdrop-blur-2xl rounded-2xl border border-gray-200 dark:border-white/5 overflow-hidden shadow-2xl flex flex-col max-h-[calc(100vh-120px)]">
                    <div className="p-5 border-b border-[#4afdef]/20 bg-white dark:bg-[#191b23]/50 flex items-center justify-between shrink-0">
                        <h3 className="font-headline font-bold text-gray-900 dark:text-white text-lg flex items-center gap-2"><span className="material-symbols-outlined text-[#4afdef]">shopping_cart_checkout</span> Resumen de Orden</h3>
                    ...
                    <div className="p-5 bg-gradient-to-t from-[#10131a] to-[#1d2027]/90 space-y-4 shrink-0 border-t border-gray-200 dark:border-white/5">
